...
# Arquivos de teste
INPUT_FILE="tests/lexical_unterminated_string_test/lexical_unterminated_string_test.c"
EXPECTED_FILE="tests/lexical_unterminated_string_test/lexical_unterminated_string_expected.txt"
