...
# Arquivos de teste
INPUT_FILE="tests/semantic_redeclared_var_test/semantic_redeclared_var_test.c"
EXPECTED_FILE="tests/semantic_redeclared_var_test/semantic_redeclared_var_expected.txt"
